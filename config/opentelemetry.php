...
return [
    ...
    'instrumentation' => [
        Instrumentation\HttpServerInstrumentation::class => [
            ...
            'excluded_paths' => [
                'Illuminate\Routing\Middleware', // Excluir middleware de Laravel
                'Illuminate\Routing\Router', // Excluir router de Laravel
                'Illuminate\Database\Query\Grammars\MySqlGrammar::compileSet', // Excluir comandos SET de MySQL
            ],
            'allowed_headers' => [],
            'sensitive_headers' => [],
        ],
